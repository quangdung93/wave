...
<div class="theme-settings">
	...
	<ul class="nav nav-tabs">
		<li class="active"><a data-toggle="tab" href="#branding">Cấu hình chung</a></li>
		<li><a data-toggle="tab" href="#homepage">Trang chủ</a></li>
		<li><a data-toggle="tab" href="#themeinfo">Thông tin themes</a></li>
	</ul>
	...
	<div class="tab-content">
		...
		<div id="homepage" class="tab-pane">
			...
			{!! theme_field('radio_btn', 'test', 'Homepage Test') !!}
		</div>
